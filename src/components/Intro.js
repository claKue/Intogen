    ...
    return (
        <div className="intro-container">
            <p>
                ...
                to identify their preferred Learning Styles. <br/><br/>
                The Learning style's data will be used to provide an overview on the basis of their nationalities and education.
